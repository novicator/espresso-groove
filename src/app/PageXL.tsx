          ...
          <div className="relative" style={{ maxWidth: '1400px', margin: '0 auto', zoom: 0.857 }}>
            ...
            >
              <Link
                ...
                style={{ width: '265.68px', height: '110.7px', gap: '7.38px', border: '2.46px solid #8a3010', borderRadius: '29.52px' }}
              >
                <img
              ...
              <Link
                ...
                style={{ width: '265.68px', borderRadius: '29.52px', border: '2.46px solid #1a4f4f' }}
              >
                {/* Top: Vinyl button */}
                <div
                  className="bg-[#2a7d7d] noisy flex items-center justify-center"
                  style={{ height: '73.8px', gap: '13.284px' }}
                >
                  <img
              ...
              <Link
                ...
                style={{ width: '265.68px', height: '110.7px', gap: '11.808px', border: '2.46px solid #3d2a52', borderRadius: '29.52px' }}
              >
                <img
              ...
              <Link
                ...
                style={{ width: '265.68px', height: '110.7px', gap: '7.38px', border: '2.46px solid #3a8abf', borderRadius: '29.52px' }}
              >
                <svg style={{ width: '36.9px', height: '36.9px', filter: 'drop-shadow(0 0 6px rgba(0,0,0,1))' }} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <Link href="/now-spinning" className="flex items-center justify-center">
                <div
                  ...
                  style={{ width: '265.68px', height: '110.7px', border: '2.46px solid #1a0f0a', borderRadius: '29.52px' }}
                >
                  <span className="text-white" style={{ fontSize: '32.472px' }}>★</span>
                  <span className="text-white font-[family-name:var(--font-libre-baskerville)]" style={{ fontSize: '26.568px', fontWeight: 900, marginInline: '7.38px' }}>
                    Now Spinning
                  </span>
                </div>
              </Link>

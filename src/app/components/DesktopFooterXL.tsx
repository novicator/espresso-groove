        ...
        <div className="flex" style={{ gap: '0px' }}>
          ...
          <div className="flex-[2]" style={{ marginLeft: '-28px' }}>
            ...
            <p
              ...
              style={{ fontSize: '32.2px', fontWeight: 900, paddingLeft: '14px', marginTop: '14px', maxWidth: '420px', textShadow: '1px 1px 3px rgba(0,0,0,0.9)' }}
            >
          ...
          <div className="flex-1" style={{ marginLeft: '-168px' }}>
            ...
            <div className="flex" style={{ gap: '35px', marginTop: '14px' }}>
              <a href="#" className="border-5 border-white rounded-full flex items-center justify-center text-white" style={{ width: '77px', height: '77px', marginLeft: '-14px' }}>
          ...
          <div className="flex-1" style={{ marginLeft: '28px' }}>
            ...
            <div style={{ marginTop: '21px' }}>
              <a href="tel:+10000000000" className="flex items-center" style={{ gap: '9.8px' }}>

    ...
    <div style={style} className={className}>
      ...
      <div style={{ marginTop: '-7vw'}}>
        ...
        <div className="flex flex-col w-full" style={{ marginTop: '8vw' }}>
          <Link href="/menu" className="relative w-full bg-[#f06830] noisy flex items-center justify-center" style={{ height: '13vw', gap: '3vw' }}>
          ...
          <Link href="/vinyl" className="relative w-full bg-[#2a7d7d] noisy flex items-center justify-center" style={{ height: '13vw', gap: '3vw' }}>
          ...
          <Link href="/merch" className="relative w-full bg-[#6b4c8c] noisy flex items-center justify-center" style={{ height: '13vw', gap: '3vw' }}>
          ...
          <Link href="/events" className="relative w-full bg-[#24ADFF] noisy flex items-center justify-center" style={{ height: '13vw', gap: '3vw' }}>
            <svg style={{ width: '8vw', height: '8vw', filter: 'drop-shadow(0 0 6px rgba(0,0,0,1))' }} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <Link href="/now-spinning" className="relative w-full bg-[#6F4E37] noisy flex items-center justify-center" style={{ height: '13vw', gap: '3vw' }}>

    ...
    <div id="site-footer-desktop">
      ...
      <div className="flex" style={{ paddingInline: '4vw', paddingTop: '4vw', paddingBottom: '3.5vw', gap: '0vw' }}>
        ...
        <div className="flex-1" style={{ marginLeft: '2vw',}}>
          {/* Contact Button */}
          <div style={{ marginTop: '3vw', marginLeft: '-1vw' }}>
            <button
              type="button"
              onClick={openContact}
              className="rounded-full inline-block"
              style={{ padding: '0.25vw', background: 'linear-gradient(135deg, #ff6b2b, #33cccc, #9b59d0)' }}
            >
              <div
                className="rounded-full bg-[#2d1f1a] flex items-center justify-center"
                style={{ paddingBlock: '1vw', paddingInline: '3.5vw' }}
              >
                <span
                  className="text-white font-[family-name:var(--font-libre-baskerville)] uppercase"
                  style={{ fontSize: '1.9vw', fontWeight: 900, letterSpacing: '0.1em', textShadow: '2px 2px 8px rgba(0,0,0,0.9)' }}
                >
                  Contact Us
                </span>
              </div>

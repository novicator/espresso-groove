...
function StacksVinylRow({ vinyls, autoScroll = false, isActive = true, rowTitle, variant = "stacks" }: { vinyls: { name: string; artist: string; img: string }[]; autoScroll?: boolean; isActive?: boolean; rowTitle?: string; variant?: "stacks" | "regular" }) {
  ...
  const cardWidth = isStacks ? '154px' : '218.4px';
...
export default function VinylXL() {
  ...
  // Persist filter changes — only after the restore has run.
  useEffect(() => {
                  ...
                  >
                    <div className="rounded-lg bg-[#2d1f1a]">
                      ...
                      >
                        ...
                        <span className="font-[family-name:var(--font-inter)] text-white/40" style={{ fontSize: '20.4px', marginTop: '4.2px' }}>Rock, Indie, Hip-Hop, and everything in between</span>
                      </button>
                    </div>
                  </div>
                )}
                  ...
                  <div className="rounded-lg overflow-hidden bg-[#2d1f1a]">
                    <div className="text-center" style={{ paddingTop: '33.6px', paddingBottom: '21px' }}>
                      ...
                      <p
                        ...
                        style={{ fontSize: '29.4px', marginTop: '7px' }}
                      >
                        {item.desc}
                      </p>
                    </div>
